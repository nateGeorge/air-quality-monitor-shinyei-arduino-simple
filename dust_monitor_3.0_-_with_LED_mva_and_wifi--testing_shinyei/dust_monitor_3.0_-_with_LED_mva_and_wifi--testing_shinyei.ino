/* Grove - Dust Sensor v3.0
 ...
 Code written around August 2014
...
#define SSID "<wifi network ID here>"
#define PASS "<password here>"
#define IP "54.86.132.254" // data.sparkfun.com

String PrKEY = "<private key here>"; // for data.sparkfun.com
String PuKEY = "<public key here>";
...
void loop() {
  ...
  if ((millis()-startTime_ms) >= sampleTime_ms)//if the sample time has been exceeded
  {
    ...
    concentration = 0.1187*ratio - 0.0865; // using spec sheet curve    
    if (printToSerial) {
